...
// const apiUrl = "https://testapi.qianjidaojia.com/";//测试服务器api地址
const apiUrl = "https://api.qianjidaojia.com/";//正试服务器api地址
...
const http = (params) => {
  const token = wx.getStorageSync('token'); console.log(wx.getStorageSync('userStorage'))
  const userId = wx.getStorageSync('userId'); console.log(token, userId)
  
  //返回promise 对象
  return new Promise((resolve, reject) => {
    wx.request({
      url: apiUrl + params.url,//服务器url+参数中携带的接口具体地址
      // data: Object.assign({UserId: 'FA8BDCCBC7AA8736'},
      //   {Token: '8359AF2851DD8536459D6A3A1697A75B'}, params.data),//彭
      // data: Object.assign({ UserId: '6731FEE8004F4FE4'},
      //   { Token: '6EE84002F15E38E4BFC72D386DE3D938'}, params.data),//段

      // data: Object.assign({ UserId: '32A8C1936C81D270'},
      //   { Token: 'B2C2A31861DCDC30C14010E48E38E422'}, params.data),//张
      // data: Object.assign({ UserId: '4CD2F3397E833ED1'},
      //   { Token: 'BB31A7074E05300E7AC1AD011F61D86A'}, params.data),//蔡
      data: Object.assign({ UserId: userId },
        { Token: token }, params.data),//请求参数
      header: {
        "token": token,
...
function _mobile(str){
  const mobile = str.substring(0, 3) + '****' + str.substring(7);
  return mobile;
}
