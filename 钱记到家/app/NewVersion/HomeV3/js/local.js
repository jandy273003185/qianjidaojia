            ...
            success: function (msg) {
                ...
                if (msg.code === 0) {
                    wx.config({
                        ...
                        jsApiList: ['checkJsApi', 'onMenuShareTimeline', 'onMenuShareAppMessage', 'setNavigationBarButtons', 'onMenuShareQQ', 'onMenuShareWeibo', 'onMenuShareQZone', 'getLocation'] // 必填，需要使用的JS接口列表，所有JS接口列表见附录2
					});
					wx.ready(function() {
                        wx.getLocation({
                            type: 'wgs84',
