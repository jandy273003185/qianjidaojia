...
/**
* 银联对账--银联对账结果异常(存疑/差错)表
*/
public class BalUnionpayUnionResultException implements Serializable {
    ...
    private static final long serialVersionUID = 9221097863645039608L;
