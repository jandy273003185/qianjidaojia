...
import com.qifenqian.bms.platform.type.ProductNameState;
 ...
 * 产品编号
 */
public class selectProductNameTag extends SimpleTagSupport{
	...
	public void doTag() throws JspException, IOException {
		...
		for (ProductNameState state : ProductNameState.values()) {
