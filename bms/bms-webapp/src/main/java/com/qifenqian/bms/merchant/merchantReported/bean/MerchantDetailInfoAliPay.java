...
public class MerchantDetailInfoAliPay  {
	...
	/**营业执照授权函图片路径'*/
	private String businessaAuthPhotoPath;
	/** 营业期限是否长期有效 */
	...
	public String getBusinessaAuthPhotoPath() {
		return businessaAuthPhotoPath;
	}
	public void setBusinessaAuthPhotoPath(String businessaAuthPhotoPath) {
		this.businessaAuthPhotoPath = businessaAuthPhotoPath;
	}
