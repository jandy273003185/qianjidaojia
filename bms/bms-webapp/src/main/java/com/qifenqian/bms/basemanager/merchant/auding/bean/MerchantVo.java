...
public class MerchantVo implements Serializable {
	...
	private List<bmsProtocolColumn> bmsProtocolColumns=new ArrayList<bmsProtocolColumn>();
	
	private List<MerchantCashier> cashierList=new ArrayList<MerchantCashier>();
	
	private String custManagerName;
	
	private String idCardF;
	private String idCardO ;
	private String businessLicenceF;
	private String businessLicenceO ;
	
    private String roleId;//区分个人跟企业的
	...
	private bmsProtocolContent protocolContent;
	
	private List<TbProvince> provList;
    
    private CategoryCodeInfo categoryInfo;
    
    private TbCity tbCity;
     
    private TbAreaInfo tbAreaInfo;
	...
	public List<bmsProtocolColumn> getBmsProtocolColumns() {
		return bmsProtocolColumns;
	}

	public void setBmsProtocolColumns(List<bmsProtocolColumn> bmsProtocolColumns) {
		this.bmsProtocolColumns = bmsProtocolColumns;
	}
	...
	public String getBusinessLicenceF() {
		return businessLicenceF;
	}

	public void setBusinessLicenceF(String businessLicenceF) {
		this.businessLicenceF = businessLicenceF;
	}

	public String getBusinessLicenceO() {
		return businessLicenceO;
	}

	public void setBusinessLicenceO(String businessLicenceO) {
		this.businessLicenceO = businessLicenceO;
	}

	public List<MerchantCashier> getCashierList() {
		return cashierList;
	}

	public void setCashierList(List<MerchantCashier> cashierList) {
	...
	public CategoryCodeInfo getCategoryInfo() {
		return categoryInfo;
	}

	public void setCategoryInfo(CategoryCodeInfo categoryInfo) {
	...
	public List<TbProvince> getProvList() {
		return provList;
	}

	public void setProvList(List<TbProvince> provList) {
		this.provList = provList;
	}

	public bmsProtocolContent getProtocolContent() {
		return protocolContent;
	}
	public void setProtocolContent(bmsProtocolContent protocolContent) {
	...
	public List<String> getDoorPhoto() {
		return doorPhoto;
	}
	public void setDoorPhoto(List<String> doorPhoto) {
