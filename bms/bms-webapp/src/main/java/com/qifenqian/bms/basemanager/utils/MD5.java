package com.qifenqian.bms.basemanager.utils;
 ...
 * </p>
 * <p>
 * Description: md5 类实现了RSA Data Security, Inc.在提交给IETF的RFC1321中的MD5
 * message-digest 算法。
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * Company: peoplewang workgroup
 * </p>
 * 
 * @author j2eewaf
 * @peoplewang@hotmail.com.com
 * @version 1.0
 */
...
public class MD5 {
	...
	public String getMD5ofStr(String inbuf) {
		...
		try {
			md5Update(inbuf.getBytes("UTF-8"), inbuf.getBytes("UTF-8").length);
		} catch (Exception e) {
			e.printStackTrace();
		}
	 ...
	 * 简单的位运算，可能出于效率的考虑把它们实现成了宏，在java中，我们把它们 现成了private方法，名字保持了原来C中的。
	 * 
	 * @param x
	 * @param y
	 * @param z
