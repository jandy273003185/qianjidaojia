package com.qifenqian.bms.basemanager.tradeRevoke.bean;
...
public class CustTransRevoke implements Serializable {
	/**
		 * 
		 */
	private static final long serialVersionUID = 3914021716491740660L;
	/** 订单号 */
	private String orderId;
	/** 原七分钱订单号 */
	private String originOrderId;
	/** 原订单名称 */
	private String originOrderName;
	/** 原交易类型 */
	private String originTradeType;
	
	private Date originTransTime;
	/** 撤销方客户号 */
	private String revokeCustId;
	/** 商户客户号 */
	...
	public String getOriginOrderName() {
		return originOrderName;
	}

	public void setOriginOrderName(String originOrderName) {
		this.originOrderName = originOrderName;
	}

	public String getOriginTradeType() {
		return originTradeType;
	}

	public void setOriginTradeType(String originTradeType) {
		this.originTradeType = originTradeType;
	}
	...
	public String getRevokeCustId() {
		return revokeCustId;
	}

	public void setRevokeCustId(String revokeCustId) {
		this.revokeCustId = revokeCustId;
	}
