...
public class BalUnionpaySevenResultEqual implements Serializable{
	private static final long serialVersionUID = 1789034467437133002L;
	...
	/** 接入类型*/				private String accessType;
	...
	/** 对账结果：EQUAL_BAL/E*/	private String balResult;
