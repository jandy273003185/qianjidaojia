...
<body>
						...
						<div class="col-xs-12">
							...
							<div class="table-responsive">
								<div id="myTabContent" class="tab-content">
									<div class="tab-pane fade in active" id="internal_result_exception">
							   			<form action='<c:url value="<%=AccountResultPath.BASE + AccountResultPath.BALINTERNALRESULTEXCEPTIONLIST%>"/>'method="post" id="searchForm">
											...
											<tr>
												...
												<td class="td-right">
													<span class="input-icon">
														<input type="text" name="clearId" id="clearId" value="${balInternalResultException.clearId }">
													</span>
												</td>
											</tr>
											<tr>
												...
												<td class="td-right">
													<span class="input-icon">
														<input type="text" name="batchId" id="batchId" value="${balInternalResultException.batchId }">
													</span>
												</td>
												<td class="td-left">会计日期</td>
												<td class="td-right">
													<span class="input-icon">
														<input type="text" name="beginWorkDate"  id="beginWorkDate" value="${balInternalResultException.beginWorkDate}" readonly="readonly" onfocus="AutoDatePicker({skin:'whyGreen',maxDate:'%y-%M-%d'})" style="background:#fff url(/static/My97DatePicker/skin/datePicker.gif) no-repeat right!important;">
														-
														<input type="text" name="endWorkDate"  id="endWorkDate" value="${balInternalResultException.endWorkDate}" readonly="readonly" onfocus="AutoDatePicker({skin:'whyGreen',maxDate:'%y-%M-%d'})" style="background:#fff url(/static/My97DatePicker/skin/datePicker.gif) no-repeat right!important;">
													</span>
												</td>
											</tr>
											<tr>
												<td colspan="6" align="center">
													<span class="input-group-btn">
														<gyzbadmin:function url="<%=AccountResultPath.BASE + AccountResultPath.BALINTERNALRESULTEXCEPTIONLIST %>">
														...
														<gyzbadmin:function url="<%=AccountResultPath.BASE + AccountResultPath.BALINTERNALRESULTEXCEPTIONEXPORT%>">
										...
										<div class="list-table-header">聚合对账异常表</div>
											<div class="table-responsive">
												<table id="sample-table-2" class="list-table">
													...
													<c:forEach items="${resultList }" var="balExternalResultException">
														<tr class="statistic">
															...
															<td>${balExternalResultException.balResultName }</td>
	...
	$(function () {	
		...
		$(".exportBut").click(function(){
			...
			var src ="<%= request.getContextPath()+ AccountResultPath.BASE+AccountResultPath.BALINTERNALRESULTEXCEPTIONEXPORT%>?beginWorkDate="+
			beginWorkDate+
				"&channelId="+
				channelId+
				"&clearId="+
