...
<%@page import="com.qifenqian.bms.expresspay.jgkjfileupload.JgkjFilePath"%>
<base target="_self">  
...
$(function() {
	...
	$(".fileUploadBtn").click(function(){
		...
		table.rows[2].cells[1].getElementsByTagName("input")[0].name=inputName;
		    ...
		    $.blockUI();
			$.ajaxFileUpload({  
		        url : window.Constants.ContextPath +'<%=JgkjFilePath.BASE + JgkjFilePath.FILEUPLOAD%>',
		        secureuri : false,
	...
	$('.deleteFileBtn').click(function(){
		...
		$.blockUI();
		$.post(window.Constants.ContextPath + '<%=JgkjFilePath.BASE + JgkjFilePath.DELETE %>', {
				'fileId' : fileId
			}, function(data) {
				$.unblockUI();
				if(data.result == 'SUCCESS'){
				...
				<div class="page-content">
				 <div class="modal fade" id="fileUploadModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					      ...
					      <div class="modal-content" style="width: 600px;">
					         ...
					         <div class="modal-body">
					            <table class="modal-input-table" id="fileTab">
									<tr>
										<td class="td-left">文件类型<span style="color:red">*</span></td>
										<td class="td-right">
									...
									<tr>
										<td class="td-left">数据日期<span style="color:red">*</span></td>
										<td class="td-right">
									...
									<tr>
										<td class="td-left">文件<span style="color:red">*</span></td>
										<td class="td-right">	
					...
					<div class="row">
						<div class="col-xs-12">
							<!-- 查询条件 -->
							<form action='<c:url value="<%=JgkjFilePath.BASE + JgkjFilePath.LIST%>"/>' method="post">
								<table class="search-table">
									...
									<tr>
										<td colspan="6" align="center">
											...
											<gyzbadmin:function url="<%=JgkjFilePath.BASE + JgkjFilePath.FILEUPLOAD%>">
							...
							<div class="list-table-header">交广科技对账/清算文件列表</div>
