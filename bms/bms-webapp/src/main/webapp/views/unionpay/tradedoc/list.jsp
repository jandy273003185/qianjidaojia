...
<%@page import="com.qifenqian.bms.unionPay.tradedoc.TradeDocPath"%>
	...
	<div class="main-container-inner">
		...
		<div class="main-content">
			...
			<div class="page-content" >
				<!-- 账户邮箱 -->
				<div >
				<form action='<c:url value="<%=TradeDocPath.BASE+TradeDocPath.LIST %>"/>' method="post">
					<table class="search-table">
					   <tr>
						...
						<td>
							<gyzbadmin:function url="<%=TradeDocPath.BASE+TradeDocPath.LIST %>">
							<button type="submit" class="btn btn-purple btn-sm">
								查询
								<i class="icon-search icon-on-right bigger-110"></i>
							</button> 
							</gyzbadmin:function>
							<!-- <button class="btn btn-purple btn-sm btn-margin clearTradeDoc" >
									清空
				...
				<!-- 持卡人信息-->
				<div >
					<div class="list-table-header">银联应收应付凭证</div>
					<table id="sample-table-2" style="border:0px; width:100%">
					 <c:forEach items="${docList}" var="doc">
						<tr class="doc" style="border:0px" >
							<td>${doc.dateSource }</td>
						</tr>
						</c:forEach>
