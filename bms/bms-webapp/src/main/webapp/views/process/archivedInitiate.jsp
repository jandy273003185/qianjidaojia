		...
		<div class="main-container-inner">
			...
			<div class="main-content">
				...
				<div class="page-content">
					    ...
					    <div class="list-table-header">我的发起已归档列表</div>
						...
						<table id="sample-table-2" class="list-table">
							...
							<tbody id ="archivedInitiate">
								<c:forEach items="${myArchivedInitiateList }" var="merchant1">
                                   <tr class="merchants" >
									   ...
									   <td>
									   	   <input type="hidden" name="processId" id = "processId1" value="${merchant1.processId }" />
								...
								<c:if test="${empty myArchivedInitiateList}">
									<tr>
						...
						<!-- 分页 -->
						<c:if test="${not empty myArchivedInitiateList}">
