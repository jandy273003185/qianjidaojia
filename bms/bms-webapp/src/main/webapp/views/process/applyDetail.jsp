						...
						<div class="col-xs-12">
							...
							<tr>
                         	...
                         	<tr>
								...
								<td class="td-right">
									<c:if test="${processAudit.emergencyDegree =='0'}">
										正常
									</c:if>
									<c:if test="${processAudit.emergencyDegree =='1'}">
										重要
									</c:if>
									<c:if test="${processAudit.emergencyDegree =='2'}">
										紧急
									</c:if>
								</td>
							...
							<tr>
								<c:if test="${processAudit.firstAuditId != null}">
									...
									<td class="td-right" width="32%">
										<input type="text" id="firstAuditRecord" value="${processAudit.firstAuditRecord }" readonly="readonly" style="background-color: #EEEEEE;" clasS="width-70"/>
									</td>
								</c:if>
						 	 </tr>
							<tr>
								<c:if test="${processAudit.secondAuditId != null}">
									...
									<td class="td-left" width="18%">审核记录：</td>
									<td class="td-right" width="32%">
										<input type="text" id="secondAuditRecord" value="${processAudit.secondAuditRecord }"  readonly="readonly" style="background-color: #EEEEEE;" clasS="width-70"/>
									</td>
								</c:if>
						 	 </tr>
							</tbody>
