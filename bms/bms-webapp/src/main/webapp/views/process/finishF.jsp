				...
				<div class="page-content">
						...
						<div class="col-xs-12">
							<div style="margin:30px 0 10px 0">
							   <button type="button"  class="btn btn-primary" onclick = "myFinish()">全部(${num }) </button>
                               <button type="button"  class="btn btn-primary" onclick = "myFinishN()">未归档(${numN }) </button>
                               <button type="button"  class="btn btn-primary" onclick = "myFinishF()">已归档(${numF })</button>
                            </div>
							<div class="list-table-header">已办流程已归档列表</div>
						...
						<table id="sample-table-2" class="list-table">
							...
							<tbody>
								<c:forEach items="${myFinishFList }" var="merchant1">
                                   <tr class="merchants" >
						...
						<!-- 分页 -->
						<c:if test="${not empty myFinishFList}">
...
//已完成
function myFinish(){
	window.location.href =window.Constants.ContextPath + '<%="/process/finish" %>';
}
//未归档
function myFinishN(){
	window.location.href =window.Constants.ContextPath + '<%="/process/finishN" %>';
}
//已归档
function myFinishF(){
	window.location.href =window.Constants.ContextPath + '<%="/process/finishF" %>';
