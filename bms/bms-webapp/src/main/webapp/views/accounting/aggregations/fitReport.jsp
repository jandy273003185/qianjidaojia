...
<body>
							...
							<div class="table-responsive">
								<div id="myTabContent" class="tab-content">
									   ...
									   <div class="tab-pane fade" id="fit">
									      		     <div class="table-responsive">
												   		<form id="tradeForm" action='<c:url value="<%=AggregationPath.BASE + AggregationPath.FITREPORT%>"/>' method="post">
															...
															<gyzbadmin:function url="<%=AggregationPath.BASE + AggregationPath.EXPORTFIT%>">
	...
	$(function () {	
		...
		$("#exportFitButA").click(function(){
			...
			var src="<%=request.getContextPath()+AggregationPath.BASE+AggregationPath.EXPORTFIT%>?balDate="+balDate+
