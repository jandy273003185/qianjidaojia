...
<body>
							...
							<div class="table-responsive">
								<div id="myTabContent" class="tab-content">
									   ...
									   <div class="tab-pane fade" id="jh">
									      	<div class="table-responsive">
												   	<form  id="tradeForm" action='<c:url value="<%=AggregationPath.BASE + AggregationPath.JHIMPEACH%>"/>' method="post">
													<table class="table search-table"  style="border:none;">	
														...
														<tr>
															...
															<gyzbadmin:function url="<%=AggregationPath.BASE + AggregationPath.JHIMPEACH%>">						
															...
															<gyzbadmin:function url="<%=AggregationPath.BASE + AggregationPath.EXPORTJHIMPEACH%>">
	...
	$(function () {	
		$("#exportImpeachBut").click(function(){
			...
			var src="<%=request.getContextPath()+AggregationPath.BASE+AggregationPath.EXPORTJHIMPEACH%>?balDate="+balDate+
