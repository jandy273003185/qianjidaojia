							...
							<div class="table-responsive">
								<div id="myTabContent" class="tab-content">
									   ...
									   <div class="tab-pane fade in active">
									      	<div class="table-responsive">
												   <form  id="tradeForm" action='<c:url value="<%=JgkjResultExceptionPath.BASE + JgkjResultExceptionPath.JGKJLIST%>"/>' method="post">
													<table class="table search-table"  style="border:none;">	
														<tr>	
															...
															<td class="td-right"  style="width:20%;">
																<span class="input-icon">
																	<input type="text"  name="sevenpayId"  id="sevenpayId" value="${queryBean.sevenpayId }"  style="width:88%;">
														...
														<tr>
															...
															<gyzbadmin:function url="<%=JgkjResultExceptionPath.BASE + JgkjResultExceptionPath.JGKJLIST%>">						
															...
															<gyzbadmin:function url="<%=JgkjResultExceptionPath.BASE + JgkjResultExceptionPath.JGKjEXPORT%>">
								...
								<table id="sample-table-2" class="list-table">
									...
									<tbody id="impeachData">
										<c:forEach items="${zytList}" var="result" >
											<tr class="result" >
	...
	<script type="text/javascript">
	 ...
	 $(function () {	
		$("#exportImpeachBut").click(function(){
			...
			var sevenpayId =$("#sevenpayId").val();
			var balDate =$("#balDate").val();
			var src="<%=request.getContextPath()+JgkjResultExceptionPath.BASE+JgkjResultExceptionPath.JGKjEXPORT%>?balDate="+balDate+
				"&endBalTime="+endBalTime+
				"&beginBalTime="+beginBalTime+
				"&sevenpayId="+sevenpayId+"";
