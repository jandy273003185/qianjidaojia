						...
						<div class="col-xs-12">
							...
							<table class="search-table">
								...
								<tr>
									...
									<td class="td-right">${operation.rtnInfo}</td>
								</tr>
							...
							<table class="search-table" style="margin-top: 10px;">
								...
								<c:forEach items="${transList }" var="trans" varStatus="status">
									...
									<!-- 交易明细 -->
									<%
									  if(Arrays.asList(RequestColumnValues.TransFlowOperate.SEVEN_BUSS_RECEIVE_REVOKE,
									...
									<%
									  }else if(trans.getTransFlowOperate() == RequestColumnValues.TransFlowOperate.JGKJ_PAYMENT_REVOKE||
									...
									%>
										...
										<%
										  }else if(Arrays.asList(RequestColumnValues.TransFlowOperate.SEVEN_CUST_PAYMENT_REVOKE,
																							RequestColumnValues.TransFlowOperate.SEVEN_CUST_RECHARGE_REVOKE).contains(trans.getTransFlowOperate())) {
																						AcctSevenTrans sevenTrans = (AcctSevenTrans)trans;
										%>
										<tr>
										<td class="bg-e" colspan="2" width="33%" align="right" style="padding-right: 60px;border-right:0px;font-size: 15px;font-weight: bold;">
										...
										<td class="bg-e" colspan="4" width="67%" align="right" style="padding-right: 50px;border-left:0px;">
											...
											%>
												...
												%>
													<%
													  if(trans.getTransFlowOperate() == RequestColumnValues.TransFlowOperate.SEVEN_CUST_PAYMENT_REVOKE&&operation.getOperType()==RequestColumnValues.MsgType.BANK_CARD_PAYMENT_REVOKE){
													%>
														<gyzbadmin:function url="<%=OperationExceptionPath.BASE + OperationExceptionPath.SEQUEL_NEXT_STEP_OPERATION%>">
															<a href="#transBaseModal"  class="tooltip-success sequelNextStepOperation" data-rel="tooltip"  data-toggle='modal' title="续作下一步">
																<button type="submit" class="btn btn-purple btn-sm">续作下一步</button>
								...
								<%
								  }else if(trans.getTransFlowOperate() == RequestColumnValues.TransFlowOperate.UNIONPAY_REVOKE||
