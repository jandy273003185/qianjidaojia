									...
									<c:forEach items="${transList }" var="trans" varStatus="status">
										...
										<%
																				  if(trans.getTransFlowOperate()==RequestColumnValues.TransFlowOperate.BUSS_SETTLE_APPLY_RECEIVE||
																															...
																															trans.getTransFlowOperate()==RequestColumnValues.TransFlowOperate.SEVEN_INNER_RECEIVE_REVOKE) {
										...
										<tr>
											...
											<td class="td-left bg-e" width="11%">业务日期</td>
											<td class="td-right" width="22%">${trans.fDate}</td>
								...
								<tr>
									...
									<td class="td-right" style="width:35%">
										<select id="chargeNetpayState" name="chargeNetpayState" clasS="width-90">
										  <option value="INIT">-撤销成功-</option>
										  <option value="AUDIT_PASS">-审核通过(核心处理成功)-</option>
										  <option value="SEND_SUCC">-发送金蝶成功-</option>
										  <option value="PAY_SUCC">-金蝶付款成功-</option>
										</select> 
									</td>
								</tr>
								<tr>	
