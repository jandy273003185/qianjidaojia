								...
								<tr>
									...
									<td class="td-right" width="23%">
										<c:choose>
											...
											<c:when test="${operation.withdrawState == '01'}">待提现</c:when>
											<c:when test="${operation.withdrawState == '02'}">核心处理中</c:when>
											<c:when test="${operation.withdrawState == '03'}">提现申请成功</c:when>
											<c:when test="${operation.withdrawState == '04'}">提现申请失败</c:when>
							...
							<table class="search-table" style="margin-top: 10px;">
								...
								<c:forEach items="${transList }" var="trans" varStatus="status">
									...
									<tr>
										...
										<td class="td-right" colspan="3">${trans.transRecordFlow.id}</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="td-right" colspan="3">${trans.transRecordFlow.originId}</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="td-right" colspan="5"><%=ReflectUtils.getDesc(trans.getTransRecordFlow().getCurrCode())%></td>
									</tr>
									<tr>
										<td class="td-left bg-e">交广交易码</td>
										<td class="td-right">${trans.transCode}</td>
										<td class="td-left bg-e">交广清算编号</td>
										<td class="td-right" colspan="3">${trans.id}</td>
									</tr>
									<tr>
										<td class="td-left bg-e">业务类型</td>
										<td class="td-right"><%=ReflectUtils.getDesc(clearJgkj.getBusinessType())%></td>
									...
									<tr>
										<td class="td-left bg-e">交广订单编号</td>
										<td class="td-right">${trans.orderNo}</td>
										<td class="td-left bg-e">交广订单描述</td>
										<td class="td-right" colspan="3">${trans.orderMemo}</td>
									</tr>
									<tr>
										...
										<td class="td-left bg-e">状态</td>
										<td class="td-right"><%=StringUtils.trimToEmpty(ReflectUtils.getDesc(clearJgkj.getStatus()))%></td>
									</tr>
									<tr>
									...
									<tr>
										<td class="td-left bg-e">业务类型</td>
										<td class="td-right"><%=ReflectUtils.getDesc(sevenTrans.getBusinessType()) %></td>
									...
									<tr>
										...
										<td class="td-left bg-e">币别</td>
										<td class="td-right">${trans.currCode}</td>
										<td class="td-left bg-e">记账前余额</td>
										<td class="td-right">${trans.balance}</td>
									</tr>
									<tr>
										<td class="td-left bg-e">收付标记</td>
										<td class="td-right"><%=ReflectUtils.getDesc(sevenTrans.getLoanFlag()) %></td>
										<td class="td-left bg-e">会计日期</td>
										<td class="td-right">${trans.workDate}</td>
									...
									<tr>
										...
										<td class="td-right" colspan="5">${trans.brief}</td>
									</tr>
								<% } %>
								</c:forEach>
								</table>
