...
<%@ include file="/include/alert.jsp"%>
		      <div class="modal-content" style="width: 100%;">
		     	...
		     	<form  id="tradeForm" action='<c:url value="<%=FinanceQueryPath.BASE + FinanceQueryPath.BALANCEWATERLIST %>"/>' method="post">
		     	<% RealTimeCustBalanceWater requestBean = (RealTimeCustBalanceWater)pageContext.findAttribute("queryBean"); %>
					<table class="search-table"  style="border:none;" >	
							...
							<tr>
								<td colspan="4" align="center">
									...
									<gyzbadmin:function url="<%=FinanceQueryPath.BASE + FinanceQueryPath.EXPORTBALANCEWATERLIST %>">
						...
						<div class="list-table-header">客户流水查询</div>						
		         	<div class="table-responsive" id="createtable">
					 	<table id="sample-table-2" class="list-table">
							...
							<tbody id="impeachData">
								...
								<% RealTimeCustBalanceWater result = (RealTimeCustBalanceWater)pageContext.findAttribute("result"); %>
									<tr class="result" >
	 ...
	 $("#exportbalancewaterlist").click(function(){
		   var beginWorkDate = $("#beginWorkDate").val();
			...
			var custId = $("#custId").val();
			 ...
			 var src="<%=request.getContextPath()+FinanceQueryPath.BASE+FinanceQueryPath.EXPORTBALANCEWATERLIST%>?businessType="+businessType+"&beginWorkDate="+beginWorkDate+"&endWorkDate"+endWorkDate+"&custId="+custId+"";
