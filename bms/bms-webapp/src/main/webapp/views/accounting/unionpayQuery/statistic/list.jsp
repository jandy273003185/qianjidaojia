...
<body>
					...
					<div class="row">
						<div class="col-xs-12">
							<ul id="myTab" class="nav nav-tabs">
						   		<li class="active"><a href="#result" data-toggle="tab" id="resultReport">结果统计报表</a></li>
						    	...
						    	<li><a href="#qfq"  data-toggle="tab"  id="qfqReport">七分钱存疑报表</a></li>
						   		...
						   		<li><a href="<%=request.getContextPath()%>/accounting/unionpayQuery/fitReport/list" data-toggle="tab"  id="fitReport">一致报表</a></li>
							</ul>

							<div class="table-responsive">
								<div id="myTabContent" class="tab-content">
									<div class="tab-pane fade in active" id="result">
							   			<form action='<c:url value="<%=UnionpayQueryPath.BASE + UnionpayQueryPath.LIST %>"/>' method="post" id="searchForm">
											...
											<tr>
												<td colspan="6" align="center">
													<span class="input-group-btn">
														<gyzbadmin:function url="<%=UnionpayQueryPath.BASE + UnionpayQueryPath.LIST%>">
														...
														<gyzbadmin:function url="<%=UnionpayQueryPath.BASE + UnionpayQueryPath.EXPORT%>">
	...
	$(function () {	
		...
		$(".exportBut").click(function(){
			...
			var src ="<%= request.getContextPath()+ UnionpayQueryPath.BASE+UnionpayQueryPath.EXPORT%>?channelId="+
			channelId+
				"&status="+
				status+
				"&workDateMin="+
