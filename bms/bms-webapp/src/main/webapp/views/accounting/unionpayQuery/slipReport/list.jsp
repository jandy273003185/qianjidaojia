...
<body>
							...
							<div class="table-responsive">
								<div id="myTabContent" class="tab-content">
									   <div class="tab-pane fade in active" id="slip">
									      	<div class="table-responsive">
												   <form  id="tradeForm" action='<c:url value="<%=UnionpayQueryPath.BASE + UnionpayQueryPath.SLIPREPORT%>"/>' method="post">
													<table class="table search-table"  style="border:none;">	
															...
															<gyzbadmin:function url="<%=UnionpayQueryPath.BASE + UnionpayQueryPath.SLIPREPORT%>">						
															...
															<button type="button" class="btn btn-purple btn-sm btn-margin clearImpeach" >
															   ...
															   <gyzbadmin:function url="<%=UnionpayQueryPath.BASE + UnionpayQueryPath.EXPORTSLIP%>"> 
								...
								<table id="sample-table-2" class="list-table">
									...
									<tbody id="impeachData">
										<c:forEach items="${slipList}" var="result" >
											<tr class="result" >
	...
	$("#exportImpeachBut").click(function(){
		...
		var src="<%=request.getContextPath()+UnionpayQueryPath.BASE+UnionpayQueryPath.EXPORTSLIP%>?beginWorkDate="+beginWorkDate+"&endWorkDate="+endWorkDate+"&batchId="+batchId+"&queryId="+queryId+"&orderId="+orderId+"&clearId="+clearId+"";
