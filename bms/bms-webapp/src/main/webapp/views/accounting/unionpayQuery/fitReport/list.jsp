...
<body>
						   ...
						   <li><a href="#fit" data-toggle="tab" id="fitReport">一致报表</a></li>
							...
							<div class="table-responsive">
								<div id="myTabContent" class="tab-content">
									   <div class="tab-pane fade in active" id="fit">
									      	<div class="table-responsive">
												  <form  id="tradeForm" action='<c:url value="<%=UnionpayQueryPath.BASE + UnionpayQueryPath.FITREPORT%>"/>' method="post">
													<table class="table search-table"  style="border:none;" >	
															<tr>							    																																
															<td class="td-left" width="14%">会计开始日期</td>
															<td class="td-right" width="20%">
															
														 		 <input type="text" name="beginWorkDate"   id="beginWorkDate" readonly="readonly" value="${requestBean.beginWorkDate }"  onfocus="AutoDatePicker({skin:'whyGreen',maxDate:'%y-%M-%d'})" style="background:#fff url(/static/My97DatePicker/skin/datePicker.gif) no-repeat right!important;"> 
															</td>
															
															<td class="td-left" width="14%">会计结束日期</td>
															<td class="td-right" width="20%">
																
														 		 <input type="text" name="endWorkDate"   id="endWorkDate" readonly="readonly" value="${requestBean.endWorkDate }"  onfocus="AutoDatePicker({skin:'whyGreen',maxDate:'%y-%M-%d'})" style="background:#fff url(/static/My97DatePicker/skin/datePicker.gif) no-repeat right!important;"> 
															</td>
															...
															<gyzbadmin:function url="<%=UnionpayQueryPath.BASE + UnionpayQueryPath.FITREPORT%>">						
															...
															<gyzbadmin:function url="<%=UnionpayQueryPath.BASE + UnionpayQueryPath.EXPORTFIT%>">	
	...
	$("#exportImpeachBut").click(function(){
		...
		var src="<%=request.getContextPath()+UnionpayQueryPath.BASE+UnionpayQueryPath.EXPORTFIT%>?beginWorkDate="+beginWorkDate+"&endWorkDate="+endWorkDate+"&batchId="+batchId+"&queryId="+queryId+"&orderId="+orderId+"&clearId="+clearId+"";
