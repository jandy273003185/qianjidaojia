...
<script type="text/javascript">
	...
	$(function(){
		...
		$(".exportBut").click(function(){
			...
			var src ="<%= request.getContextPath()+ BussTransferPath.BASE+BussTransferPath.BUSSTRANSFEREXPORT%>?orderId="+
			         orderId+
			         "&payerCustId="+
					 payerCustId+
					 "&payerCustName="+
			...
			<div class="main-content">
				...
				<div class="page-content" >
					<div class="row">
						<div class="col-xs-12">
						<!-- 查询条件 -->
						    <form id="tradeForm" action='<c:url value="<%=BussTransferPath.BASE + BussTransferPath.LIST %>"/>' method="post">
							    <table class="search-table">
									...
									<tr>
										...
										<span class="input-group-btn"  style="display:inline;">
													<gyzbadmin:function url="<%=BussTransferPath.BASE + BussTransferPath.LIST %>">
												...
												<gyzbadmin:function url="<%=BussTransferPath.BASE + BussTransferPath.BUSSTRANSFEREXPORT%>">
												<span class="input-group-btn" style="display:inline;">
							...
							<table id="sample-table-2" class="list-table">
									<thead>
										<tr>
											...
											<th width="10%">订单名称</th>
											<th width="5%">订单描述</th>
											<th width="8%">付方商户编号</th>
											<th width="8%">付方商户名称</th>
											<th width="8%">收方商户编号</th>
											<th width="8%">收方商户名称</th>
		         ...
		         <div class="modal-body">
		           <table class="modal-input-table" border="1">
		           		<tr >
							...
							<td class="td-left" width="18%">七分钱订单号:</td>
							<td class="td-right" width="32%">
