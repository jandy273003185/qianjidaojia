...
<script type="text/javascript">
	...
	function merchantInfo(obj){
		...
		$("#updateMerchant .merchantName").text(merchant.agentName);
					...
					<div class="row">
						...
						<!-- 查询条件 -->
							...
							<table class="search-table">
								<tr>
									<td class="td-left" width="18%">服务商编号</td>
									<td class="td-right" > 
										<span class="input-icon">
											<input type="text"  name="agentId" id="agentId"  value="${queryBean.agentId}">
							...
							<div class="table-responsive">
								<table id="sample-table-2" class="list-table">
									<thead>
										<tr>
											<th width="20%">服务商编号</th>
											<th width="30%">服务商名称</th>
											<th width="10%">服务商状态</th>
											<th width="10%">服务商协议</th>
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${infos}" var="tradeInfo" varStatus="status">
											<tr class="merchantInfo" >
												<td>${tradeInfo.agentId }</td>
												<td>${tradeInfo.agentName }</td>
												<td>
												激活
												 </td>
												<td>
			...
			<div class="modal-dialog" style="width:60%;z-index:90;" >
		      <div class="modal-content" style="width:950px;" id="merchantDiv">
		         <div class="modal-header" style="background-color:0099CC">
		            ...
		            <h4 class="modal-title" id="myModalLabel">服务商协议信息</h4>
		         </div>
