...
<%@page import="com.qifenqian.bms.basemanager.agency.registAudit.RegistAuditPath" %>
...
<html lang="zh-CN">
  <head>
	...
	function returnList(){
		window.location.href = "<%=RegistAuditPath.BASE + RegistAuditPath.LIST%>";
	}
	<!--未通过审核-->
	function noPassAudi(){
	...
	function audit(merchantCode,result,auditInfo){	
		$.post(window.Constants.ContextPath +"<%=RegistAuditPath.BASE + RegistAuditPath.AUDIT %>",
				{
  ...
  <body>
        ...
        <nav>
            <div class="container-fluid">
                ...
                <div class="col-xs-2 navbar-name"><a href="#" onclick="returnList()">返回服务商列表</a></div>
            </div>  
        </nav>
        <!--内容-->
                 ...
                 <div class="grey-line"></div> 
                      <!--联系人-->
                        ...
                        <div class="form-horizontal mt30 border-grey wid9">
                         ...
                         <%--  <h5 class="business-list-h5">营业执照</h5>
                          <div class="form-group">
							...
							<div class="col-xs-4 pd0 mt10">
								<img src="/basemanager/agency/registAudit/showImage?src=${merchantInfo.businessLicenseFPath}" width="80" height="80"> 
							</div>
						</div>
                         ...
                         <%-- <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-xs-4 pd0">
                               <div class="form-control border-none">
                               		<c:if test="${merchantInfo.certifyType == '00'}">
                               			大陆居民身份证
                               		</c:if>
                               		<c:if test="${merchantInfo.certifyType == '01'}">
                               			香港居民身份证
                               		</c:if>
                               		<c:if test="${merchantInfo.certifyType == '02'}">
                               			澳门居民身份证
                               		</c:if>
                               		<c:if test="${merchantInfo.certifyType == '03'}">
                               			台湾居民身份证
                               		</c:if>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-xs-4 pd0 mt10" style="z-index:999">
                            	<a data-toggle='modal' class="tooltip-success"  data-target="#previewImageModal" >
									<img src="<%=request.getContextPath() %>/basemanager/agency/registAudit/showImage?src=${merchantInfo.idCardFPath}" onclick="bigImg(this)" width="80" height="80"> 
								</a>
							</div>
                          </div>
                         <div class="form-group">
                            ...
                            <div class="col-xs-4 pd0 mt10" style="z-index:999">
                            	<a data-toggle='modal' class="tooltip-success"  data-target="#previewImageModal" >
									<img src="<%=request.getContextPath() %>/basemanager/agency/registAudit/showImage?src=${merchantInfo.idCardOPath}" onclick="bigImg(this)" width="80" height="80"> 
								</a>
							</div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-xs-4 pd0">
                               <div class="form-control border-none">${merchantInfo.certifyNo }</div>
                            </div>
                          </div>
                          <%-- <div class="form-group">
                       ...
                       <div class="form-horizontal mt30 border-grey wid9">
                          ...
                          <div class="form-group">
                            <div class="col-xs-4 control-label">结算银行卡正面照：</div>
                            <div class="col-xs-4 pd0 mt10" style="z-index:999">
                            	<a data-toggle='modal' class="tooltip-success"  data-target="#previewImageModal" >
									<img src="<%=request.getContextPath() %>/basemanager/agency/registAudit/showImage?src=${merchantInfo.bankCardPhotoPath}"  onclick="bigImg(this)" width="80" height="80"> 
								</a>
							</div>
                          </div>
                          <c:if test="${merchantInfo.compMainAcctType == '02'}">
								<div class="form-group">
									...
									<div class="col-xs-4 pd0 mt10" style="z-index:999">
										<a data-toggle='modal' class="tooltip-success"  data-target="#previewImageModal" >
											<img src="<%=request.getContextPath() %>/basemanager/agency/registAudit/showImage?src=${merchantInfo.bankCardPhotoPath}" onclick="bigImg(this)"
												width="80" height="80">
										</a>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-xs-4 pd0 mt10" style="z-index:999">
										<a data-toggle='modal' class="tooltip-success"  data-target="#previewImageModal" >
											<img src="<%=request.getContextPath() %>/basemanager/agency/registAudit/showImage?src=${merchantInfo.idCardScPhotoPath}" onclick="bigImg(this)"
												width="80" height="80">
										</a>
									</div>
								</div>
                          ...
                          <div class="form-group">
                            <div class="col-xs-4 control-label">结算卡开户行支行名称：</div>
                            <div class="col-xs-4 pd0">
                               <div class="form-control border-none">${merchantInfo.branchBank }</div>
                            </div>
                          </div>
                        </div>
                        ...
                        <!--营业执照-->
                       <c:if test="${merchantInfo.businessLicense != null && merchantInfo.businessLicense != ''}">
                       <div class="form-horizontal mt30 border-grey wid9">
                          <div class="business-list-tit">
                              <h4>营业执照</h4>
                          </div>
                          <div class="form-group">
                            <div class="col-xs-4 control-label">营业执照：</div>
                            <div class="col-xs-4 pd0 mt10" style="z-index:999">
                            	<a data-toggle='modal' class="tooltip-success"  data-target="#previewImageModal" >
									<img src="<%=request.getContextPath() %>/basemanager/agency/registAudit/showImage?src=${merchantInfo.businessLicenseFPath}"  onclick="bigImg(this)" width="80" height="80"> 
								</a>
							</div>
                          </div>
                       ...
                       <div class="form-horizontal mt30 border-grey wid9">
                          ...
                          <div class="form-group">
                            ...
                            <c:forEach items="${product}" var="products">  
						         <tr> 
						         	<td></td>
						         	<td width=90px>产品类型:</td>
						         	<td >
							         	<c:if test="${products.productCode == 'APP_PAY'}">
	                               			APP支付
	                               		</c:if> 
	                               		<c:if test="${products.productCode == 'SCAN_PAY'}">
	                               			扫码支付
	                               		</c:if>
	                               		<c:if test="${products.productCode == 'H5_PAY'}">
	                               			H5支付
	                               		</c:if>
	                               		<c:if test="${products.productCode == 'OA_PAY'}">
	                               			公众号支付
	                               		</c:if>
	                               		<c:if test="${products.productCode == 'MINI_PAY'}">
	                               			小程序支付
	                               		</c:if>
                               		</td>
                               		<td width=90px>期望费率:</td>
						            <td style=“word-break:break-all;”>${products.signRate}</td>  
						         </tr>  
							</c:forEach>  
							</table>
                            </div>
