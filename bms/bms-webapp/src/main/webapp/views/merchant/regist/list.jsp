...
$(function(){
	...
	$('.exportBut').click(function(){
		...
		var src ="<%= request.getContextPath()+ MerchantPath.BASE+MerchantPath.EXPORTMERCHANTINFO%>?merchantCode="+
		merchantCode+
		"&startCreateTime="+
		startCreateTime+
		"&endCreateTime="+
				...
				<div class="page-content">
					<div class="row">
						...
						<input type="hidden" id="doorPhototemp" />
							<!-- 查询条件 -->
						<form  id="merchantForm" action='<c:url value="<%=MerchantPath.BASE + MerchantPath.LIST %>"/>' method="post">
								...
								<tr>
									...
									<td colspan="6" align="center">
										<span class="input-group-btn">
											<gyzbadmin:function url="<%=MerchantPath.BASE + MerchantPath.LIST %>">
