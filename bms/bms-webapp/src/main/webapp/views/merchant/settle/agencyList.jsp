...
<script type="text/javascript">
	...
	$(function(){
		$(".exportBut").click(function(){
			...
			var src ="<%= request.getContextPath()+ MerchantSettlePath.BASE+MerchantSettlePath.AGENCYEXPORT%>?"+
				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							...
							<form action='<c:url value="<%=MerchantSettlePath.BASE + MerchantSettlePath.AGENCYLIST %>"/>' method="post" id="searchForm">
								...
								<tr>
									<td colspan="8" align="center">
										<span class="input-group-btn">
											<gyzbadmin:function url="<%=MerchantSettlePath.BASE + MerchantSettlePath.AGENCYLIST %>">
